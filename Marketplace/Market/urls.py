...
urlpatterns = [
    ...
    path('profile/<int:primary_key>/product/<int:pk>/modify/', views.modify_product.as_view(),
         name="modify_product_profile"),
    path('profile/<int:primary_key>/product/<int:pk>/delete/', views.delete_product.as_view(),
